        ...
        <div className="h-min relative">
          <img
            ...
            className={`grayscale transition-all duration-300 ${
              isActive && "sm:grayscale-0 sm:scale-[1.3]"
            }`}
          />
          <div
            className={`md:shadow
            absolute top-0 left-0 h-[100%] w-[100%] flex flex-col
            text-[18px] xs:text-sm sm:text-md lg:text-[15px] 
            transition duration-300 items-center text-center
            justify-center p-2
          ${
            isActive
              ? "sm:scale-[1.3] bg-white bg-opacity-50 md:bg-transparent text-black md:text-transparent"
              : "text-transparent"
          }
          ...
          >
            <p className="mx-10 xs:mx-0">
              <span
                className={`p-[3px] inline-block sm:bg-transparent`}
              >
                {article.title}
              </span>
              ...
              <br />
              <span
                className={`mt-1 font-bold p-[2px] inline-block  sm:bg-transparent`}
              >
                {article.publisher}
              </span>
            </p>
